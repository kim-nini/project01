$(document).ready(function(){
	let login = $(".links").find("li").find("#login") ;
	...
	login.on("click",function(e){
		...
		first_input.removeClass("first-input__block").addClass("login-input__block");
		hidden_input.css({
			"opacity" : "1",
			"display" : "block"
		});
...
document.querySelector('#passwd').addEventListener('input', pwCheck);
